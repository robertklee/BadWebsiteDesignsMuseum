...
export const exhibits = [
  { id: "recipe", name: "The Recipe Odyssey", category: "Content", color: "green", tagline: "Two ingredients. Six compulsory quizzes.", description: "Prove you read the memoir before you're allowed to make toast.", lesson: "Toast should never be attempted without a full understanding of the author's childhood summers. The bread can wait.", fix: "The ingredients have been moved above the memoir. Breakfast may now proceed.", worseChange: "The memoir has a long memory, especially when you get an answer wrong.", preview: `<div class="thumb-scene thumb-recipe"><span class="thumb-kicker">A PINCH OF PATIENCE</span><div class="thumb-toast-intro"><div class="thumb-toast" aria-hidden="true"><i></i></div><div><strong>Toast.</strong><span>2 ingredients.<br>6 compulsory quizzes.</span></div></div><div class="thumb-recipe-gate"><span>BEFORE WE COOK</span><b>What did Grandma own?</b><small>Breakfast is an open-book exam.</small></div></div>`, render: renderRecipe },
  { id: "terms-game", name: "Terms & Conditions: The Game", category: "Content", color: "lilac", tagline: "You clicked “I read it.” Defend your thesis.", description: "An absurdly long agreement. Buried facts. A compulsory reading exam.", lesson: "By continuing, you confirm that you remember Clause 47 and its emotional arc. The oral defense has been postponed.", fix: "The agreement has become a short summary with two buttons and no final exam.", worseChange: "The fine print has expanded, and the exam is no longer feeling generous.", preview: `<div class="thumb-scene thumb-terms"><span class="thumb-kicker">A SMALL FOLLOW-UP TO THE FINE PRINT</span><div class="thumb-terms-check">☑ I have read the terms</div><div class="thumb-exam"><span>READING EXAM / QUESTION 1 OF 8</span><strong>Lovely.<br>Prove it.</strong><div class="fake-lines"></div></div><small class="thumb-footer">The checkbox brought homework.</small></div>`, render: renderTermsGame },
  { id: "mystery-menu", name: "The Mystery Meat Menu", category: "Navigation", color: "blue", tagline: "Six icons. Zero useful clues.", description: "Find a shipping policy and a receipt behind meaningless symbols.", lesson: "Labels would spoil the surprise. Each icon is a tiny adventure with paperwork hidden at the end.", fix: "The icons now have names. Their mysterious era was brief but influential.", worseChange: "The icons refuse to stay loyal to any destination.", preview: `<div class="thumb-scene thumb-mystery"><span class="thumb-kicker">YOUR RECEIPT IS ONE OF THESE</span><div class="thumb-symbol-menu"><span>⌘</span><span>◇</span><span>✳</span><span>◌</span><span class="thumb-mystery-active">⧉</span><span>⌁</span></div><div class="thumb-useless-tooltip">The other thing.</div><small class="thumb-footer">Six icons. A small paperwork adventure.</small></div>`, render: renderMysteryMenu },
