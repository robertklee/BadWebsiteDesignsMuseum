...
export const exhibits = [
  { id: "runaway", name: "The Runaway Button", category: "Interaction", color: "lilac", tagline: "A call to action. A refusal to cooperate.", description: "Finally, a button with a healthy fear of commitment.", lesson: "The button has considered your request and chosen flight. It is currently exploring opportunities near the opposite edge of the box.", fix: "After extensive negotiations, the button has agreed to remain in one place.", worseChange: "Detects an approaching pointer, shrinks the real button, leaves clickable decoys, relocates faster on touch, and raises the typical catch from 8 direct hits to 20 (18–24 total).", preview: `<div class="preview-runaway"><span class="pointer p1">↖</span><span class="little-label">come back here.</span><span class="fake-button">Click me <span>↗</span></span><span class="pointer p2">↖</span><span class="dotted-path"></span></div>`, render: renderRunaway },
  ...
  { id: "loading", name: "The Loading Experience", category: "Interaction", color: "lilac", tagline: "Almost ready to start getting ready.", description: "An entire loading ceremony for one sentence. Please approve the wait.", lesson: "Nothing important is happening, but it is happening in ten impressive stages. Stage eleven is reflecting on the journey.", fix: "The sentence was ready the whole time. It has finally been allowed indoors.", worseChange: "Interrupts the fake loading process for three mandatory approvals.", preview: `<div class="new-preview preview-loading"><span>PREPARING TO ALMOST FINISH</span><div class="preview-loader-ring"></div><strong>99%</strong><small>Reconsidering the first 98%.</small></div>`, render: renderLoading },
  { id: "seismic-editor", name: "The Seismic Text Editor", category: "Interaction", color: "pink", tagline: "Every keystroke is a structural risk.", description: "Type carefully. The editor shakes, and your whole sentence might tumble.", lesson: "The sentence was built on ambitious foundations. Punctuation remains a known seismic risk, especially the excitable kind.", fix: "The editor passed inspection. Exclamation marks may now enter without a hard hat.", worseChange: "Builds structural stress twice as fast and shakes the editor harder.", preview: `<div class="new-preview preview-seismic"><span>STRUCTURAL INTEGRITY: QUESTIONABLE</span><div><b>T</b><b>Y</b><b>P</b><b>E</b></div><small>One more letter. What could go wrong?</small><i>CAUTION: UNSTABLE WORDS</i></div>`, render: renderSeismicEditor },
  { id: "wind-volume", name: "The Windswept Volume Slider", category: "Interaction", color: "blue", tagline: "Forecast: scattered decibels.", description: "Drag a volume slider through a gale. Up is subject to weather.", lesson: "Today's forecast calls for shifting controls with a chance of accidental silence. Up may become down by evening.", fix: "The slider has been moved indoors, where the forecast is consistently 37 percent.", worseChange: "Strengthens the gusts and can turn the slider upside down.", preview: `<div class="new-preview preview-wind"><span>VOLUME ADVISORY IN EFFECT</span><strong>~~~ / ~~~</strong><div>37% &nbsp; 82% &nbsp; 4%?</div><small>The slider is experiencing weather.</small></div>`, render: renderWindVolume },
  { id: "tetris-volume", name: "The Tetris Volume Control", category: "Interaction", color: "blue", tagline: "Turn it up. Build it up.", description: "Stack blocks across a game board to adjust a completely silent volume slider.", lesson: "Sound levels are a construction project. Please occupy two-thirds of the site without accidentally finishing a row.", fix: "The building permit expired, leaving behind one ordinary volume slider.", worseChange: "More than doubles the falling speed.", preview: `<div class="new-preview preview-tetris"><span>BUILD YOUR OWN DECIBELS</span><strong>▟ ▙ ▟</strong><div class="preview-track"><i></i></div><small>Full rows vanish. So does the volume.</small></div>`, render: renderTetrisVolume },
  { id: "volume-seesaw", category: "Interaction", color: "blue", name: "The Volume Seesaw", tagline: "A delicate balance of unnecessary effort.", description: "Load weights onto a wobbling seesaw to set a silent volume slider.", lesson: "The ideal listening level is a delicate agreement between anvils and balloons. Pebbles are present in an advisory role.", fix: "The playground equipment was removed, revealing a slider underneath.", worseChange: "Adds negative-weight balloons and rolls a weight to the opposite tray after every third addition.", preview: '<div class="new-preview preview-seesaw"><span>PLEASE BALANCE THE DECIBELS</span><strong>■ ━━━━━ ●</strong><div>▲</div><small>One more brick should fix it.</small></div>', render: renderVolumeSeesaw },
  { id: "notification-swatter", category: "Interaction", color: "yellow", name: "The Notification Fly Swatter", tagline: "Please dismiss your way to productivity.", description: "Swat a swarm of fake alerts before they bury the form you are completing.", lesson: "Your focus is important to us, which is why twelve messages have arrived to discuss it. More may be scheduled.", fix: "The notifications have been shown the door. The form can finally hear itself think.", worseChange: "Spawns alerts faster and creates another alert whenever you miss.", preview: '<div class="new-preview preview-swatter"><span>NEW ALERT ABOUT YOUR ALERTS</span><strong>✉ × ✉</strong><div>3 messages about your 2 messages.</div><small>Your form is underneath these.</small></div>', render: renderNotificationSwatter },
];
