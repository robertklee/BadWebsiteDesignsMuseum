const arcadeExhibits = [
  { id: "password-crane", number: "26", category: "Forms", color: "lilac", name: "The Password Crane Game", tagline: "Your next character is just out of reach.", description: "Steer a claw across all 128 ASCII characters to construct a fictional password.", lesson: "Typing should not require spatial precision, luck, or an arcade game. Let people enter and paste passphrases directly, with predictable controls and clear requirements.", fix: "A normal field for an invented demo phrase. No claws, no lost letters, and no real credentials." },
  { id: "physics-cart", number: "27", category: "Commerce", color: "orange", name: "The Physics Shopping Cart", tagline: "Your basket has checkout momentum.", description: "Every product makes a wheeled cart roll faster toward an entirely imaginary purchase.", lesson: "Adding items must not create momentum toward a purchase. Keep baskets stable, allow easy editing, and require an explicit, informed checkout action.", fix: "A stationary basket, clear quantities and totals, and a deliberate simulation-only checkout button." },
];
