const additionalExhibits = [
  { id: "alphabet", name: "The Alphabet Shuffle", category: "Forms", number: "07", color: "pink", tagline: "A slider with no alphabetic loyalties.", description: "Find a letter. Add it. The entire slider order changes.", lesson: "Spatial memory helps people use controls. Randomizing a slider's meaning after each selection destroys that memory, and sliders are a poor substitute for a keyboard.", fix: "A normal text field. Every key keeps its meaning, and your message stays yours." },
  { id: "phone", name: "The Phone Number Casino", category: "Forms", number: "08", color: "orange", tagline: "Your number is somewhere in these odds.", description: "Roll each digit. Lock it. Hope the next roll respects it.", lesson: "Randomness has no place in entering known information. Let people type and paste phone numbers, and never discard a digit they have already entered.", fix: "Type or paste the demo number into a telephone field. No luck required." },
  { id: "calendar", name: "The Calendar Treadmill", category: "Forms", number: "09", color: "blue", tagline: "A date picker with no sense of direction.", description: "Book an appointment, one painfully small calendar step at a time.", lesson: "A date picker should support direct entry and predictable navigation. Making people calculate offsets or repeatedly step through days adds unnecessary work.", fix: "A native date field with direct entry, a calendar, and clear validation." },
  { id: "volume", name: "The Volume Gym", category: "Interaction", number: "10", color: "green", tagline: "Turn it up. Do some math. Start again.", description: "A volume control that requires modular arithmetic and physical effort.", lesson: "Continuous settings need direct, stable controls. Arbitrary increments, wraparound, and values that decay by themselves make a simple adjustment unpredictable.", fix: "One slider, a visible percentage, and a value that stays where you put it." },
  { id: "cookies", name: "The Cookie Switchboard", category: "Forms", number: "11", color: "yellow", tagline: "Your preferences. Our creative interpretation.", description: "Turn one cookie off. Watch another turn on. Try to reject them all.", lesson: "Consent controls must be independent and honest. Rejecting optional cookies should be as easy as accepting them, and saved settings must match the person's choices.", fix: "Independent switches and a single Reject all button. No cookies are actually used." },
  { id: "cancel", name: "The Cancellation Labyrinth", category: "Copywriting", number: "12", color: "lilac", tagline: "Don't not stop uncancelling your subscription.", description: "Escape a fictional subscription through a maze of double negatives.", lesson: "Cancellation should be easy to find and complete. Ambiguous labels, repeated confirmations, and retention detours undermine a person's explicit choice.", fix: "One clearly labeled cancellation button. One unambiguous confirmation." },
  { id: "ai-store", name: "The AI Everything Store", category: "Commerce", number: "13", color: "blue", tagline: "Your spoon now requires a prompt.", description: "Buy ordinary objects through unnecessary AI onboarding and subscriptions.", lesson: "Adding AI to a simple task can introduce friction without adding value. Let people buy and use ordinary products without prompts, training rituals, or mandatory subscriptions.", fix: "Ordinary products, clear one-time prices, and a direct Add to basket button. No artificial intelligence required." },
  { id: "unix-birthday", name: "The Unix Birthday Picker", category: "Forms", number: "14", color: "green", tagline: "Happy 631152000000 to you.", description: "Slide through milliseconds since 1970. Snap your birthday to midnight.", lesson: "Storage formats are not user interfaces. Birthdays should use familiar date controls, not require epoch arithmetic, unit conversions, or timezone knowledge.", fix: "Choose a familiar calendar date. The computer handles the Unix milliseconds internally." },
  { id: "loading", name: "The Loading Experience", category: "Interaction", number: "15", color: "lilac", tagline: "Almost ready to start getting ready.", description: "An entire loading ceremony for one sentence. Please approve the wait.", lesson: "Progress indicators should reflect real work, not manufacture a delay. Avoid fake percentages, regressing progress, and making people authorize a loading animation.", fix: "The sentence appears immediately. There was never any work to wait for." },
  { id: "fonts", name: "The Font Buffet", category: "Typography", number: "16", color: "pink", tagline: "Every word has a different art director.", description: "Type a sentence. Watch its fonts, sizes, and styles disagree.", lesson: "Typography creates hierarchy and makes content readable. Random fonts, sizes, rotations, and spacing force people to decipher text instead of reading it.", fix: "One readable typeface, consistent sizing, and comfortable line spacing. Your words take priority." },
  { id: "horizontal", name: "The Horizontal Lifestyle", category: "Navigation", number: "17", color: "yellow", tagline: "Your next section is somewhere to the right.", description: "A sideways website with vertical navigation and directionally confused arrows.", lesson: "Unexpected scroll directions and reversed controls fight established navigation habits. Keep the page flow predictable and make all sections reachable by keyboard and touch.", fix: "A normal vertical page with clear navigation. Scrolling down takes you down." },
  { id: "mystery-menu", name: "The Mystery Meat Menu", category: "Navigation", number: "18", color: "blue", tagline: "Six icons. Zero useful clues.", description: "Find a shipping policy and a receipt behind meaningless symbols.", lesson: "Navigation should describe destinations, not ask people to decode unfamiliar icons. Keep labels clear and the relationship between a control and its destination stable.", fix: "Every destination gets a clear text label, and the menu stays in the same order." },
  { id: "password-gym", name: "The Password Gym", category: "Forms", number: "19", color: "orange", tagline: "Twenty rules. Or thirty-two and no way out.", description: "Rules unlock as you type. Worse mode eventually contradicts itself.", lesson: "Moving password requirements create unnecessary frustration; contradictory rules make success impossible. Show reasonable requirements upfront, allow long passphrases, and avoid arbitrary composition puzzles. This exhibit is not a password-strength evaluator.", fix: "One visible length requirement, with pasting allowed and no surprise rules. Use only an invented demo phrase." },
  { id: "terms-game", name: "Terms & Conditions: The Game", category: "Content", number: "20", color: "lilac", tagline: "You clicked “I read it.” Defend your thesis.", description: "An absurdly long agreement. Buried facts. A compulsory reading exam.", lesson: "Making consent depend on an endurance test does not create informed consent. Use a concise, understandable summary and give people equally clear accept and decline choices.", fix: "A short plain-language summary. Accept or decline without a quiz. This parody never creates a real agreement." },
  { id: "seismic-editor", name: "The Seismic Text Editor", category: "Interaction", number: "21", color: "pink", tagline: "Every keystroke is a structural risk.", description: "Type carefully. The editor shakes, and your whole sentence might tumble.", lesson: "Typing should not destabilize an interface or threaten someone's work. Keep controls still, preserve input, and make recovery straightforward instead of turning every edit into a gamble.", fix: "A stable editor. No shaking, no collapse risk, and your text stays exactly where you put it." },
  { id: "wind-volume", name: "The Windswept Volume Slider", category: "Interaction", number: "22", color: "blue", tagline: "Forecast: scattered decibels.", description: "Drag a volume slider through a gale. Up is subject to weather.", lesson: "A control's position and direction should have a stable relationship to its value. Moving the track under someone's pointer makes precision impossible to trust.", fix: "A sheltered vertical slider with predictable movement and a steady readout. All volume values are pretend; your device volume never changes." },
  { id: "cat-captcha", name: "The CAT-PCHA", category: "Forms", number: "23", color: "yellow", tagline: "Prove you're human. Be a mouse.", description: "Collect the cheese and escape a hunting cat to pass a pretend CAPTCHA.", lesson: "Verification should not require winning a game, solving a maze, or making precise movements. Offer accessible, low-friction alternatives rather than turning a routine task into an obstacle course.", fix: "A simple demo checkbox and confirmation button. Neither version is a real security check." },
  { id: "tetris-volume", name: "The Tetris Volume Control", category: "Interaction", number: "24", color: "blue", tagline: "Turn it up. Build it up.", description: "Fill the bottom of a block game to adjust a completely silent volume slider.", lesson: "Settings should respond directly to intent. Requiring a game to change volume adds effort, precision demands, and failure states to a simple adjustment.", fix: "One normal volume slider. The number changes directly, and nothing plays aloud." },
  { id: "shrinking-unsubscribe", name: "The Shrinking Unsubscribe Button", category: "Commerce", number: "25", color: "pink", tagline: "Your subscription grows. Your exit shrinks.", description: "A fictional subscription with a cancel button that shrinks and relocates as you approach.", lesson: "Cancellation must remain visible and actionable. Shrinking or moving a control to defeat someone's intent is an obstructive dark pattern, not clever retention.", fix: "A stable cancellation button that ends the fictional subscription in one click." },
  ...arcadeExhibits,
  ...
  if (id === "alphabet") {
    ...
    if (!fixed) {
      ...
      stage.querySelector("#append-character").addEventListener("click", () => {
        if (message.value.length >= 140) { say("140 characters is the limit. Your patience is impressive."); return; }
...
function renderSeismicEditor({ stage, mode, shell, say }) {
  ...
  stage.querySelector("#quake-finish").addEventListener("click", () => {
    if (!input.value.trim()) { say("Enter a sentence first. An empty platform is not a finished thought."); return; }
    cancelAnimations();
    finished = true;
    paint();
