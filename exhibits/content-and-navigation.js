...
export const exhibits = [
  { id: "recipe", name: "The Recipe Odyssey", category: "Content", color: "green", tagline: "Two ingredients. Six compulsory quizzes.", description: "Prove you read the memoir before you're allowed to make toast.", lesson: "Toast should never be attempted without a full understanding of the author's childhood summers. The bread can wait.", fix: "The ingredients have been moved above the memoir. Breakfast may now proceed.", worseChange: "Resets all reading progress after a wrong answer or an attempt to skip.", preview: `<div class="preview-recipe"><span class="recipe-blog">a pinch of patience</span><strong>It all began<br>with my grandmother...</strong><div class="fake-lines"></div><div class="fake-lines short"></div><span class="recipe-distance">↓ Recipe: 6 quizzes away</span></div>`, render: renderRecipe },
  { id: "terms-game", name: "Terms & Conditions: The Game", category: "Content", color: "lilac", tagline: "You clicked “I read it.” Defend your thesis.", description: "An absurdly long agreement. Buried facts. A compulsory reading exam.", lesson: "By continuing, you confirm that you remember Clause 47 and its emotional arc. The oral defense has been postponed.", fix: "The agreement has become a short summary with two buttons and no final exam.", worseChange: "Doubles the agreement to 160 clauses, asks 12 questions, and hides clause references unless you spend one of five hints. Wrong answers restart the exam without refunding hints.", preview: `<div class="new-preview preview-terms"><span>JUST A FEW QUICK TERMS</span><strong>§ 74.2(b)</strong><div class="fake-lines"></div><div class="fake-lines"></div><small>There will be an exam.</small></div>`, render: renderTermsGame },
