const exhibits = [
  ...
  { id: "word-editor", name: "The Dropdown Word Processor", category: "Forms", number: "04", color: "orange", tagline: "A whole document. One dropdown per character.", description: "Write, edit, and regret every letter you select from a menu.", lesson: "Dropdowns are for choosing from a short list, not writing a document. Making every character a separate control destroys typing flow and turns simple editing into repetitive menu navigation.", fix: "A normal text editor with typing, pasting, selection, and undo. The keyboard is finally allowed to do its job." },
  { id: "recipe", name: "The Recipe Odyssey", category: "Content", number: "05", color: "green", tagline: "Two ingredients. Six compulsory quizzes.", description: "Prove you read the memoir before you're allowed to make toast.", lesson: "Do not gate useful content behind irrelevant tasks. A skip button should skip, not send people to an ad. Make the recipe immediate and the background story optional.", fix: "The ingredients and method come first. The family story is optional. No quizzes required." },
    ...
    if (!fixed) {
      ...
      const renderPermit = () => {
        ...
        permit.querySelector("#add-letter").addEventListener("click", () => {
          if (message.value.length >= 280) { say("You've reached the 280-character limit. Truly heroic."); return; }
